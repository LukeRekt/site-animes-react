        ...
        <div className={styles.header}>
            ...
            <div className={styles.usuario}>
                ...
                <div className={styles.perfil}>
                    {user ? (<img onClick={toggleProfile} className={styles.avatar} src={avatar} alt="Perfil" />) : (<img onClick={toggleProfile} className={styles.avatar} src={`${process.env.REACT_APP_API_URL}/static/imagens/avatars/default.png`} alt="" />)}
