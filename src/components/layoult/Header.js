        ...
        <div className={styles.header}>
            ...
            <div className={styles.usuario}>
                ...
                <div className={styles.perfil}>
                    ...
                    {user ? (<img onClick={toggleProfile} className={styles.avatar} src={avatar} alt="Avatar do usuário" />) : (<img onClick={toggleProfile} className={styles.avatar} src="http://192.168.1.2:3232/static/imagens/avatars/default.png" alt="" />)}
