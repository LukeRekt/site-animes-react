...
const { addAnime, listar, getanime, getEpisode, getEpisodes, getAllEpisodes, getEpisodespage, getSeasonEpisodes, AddEpisode, setTeste, setUpdateEpisode} = require("../controllers/animes")
